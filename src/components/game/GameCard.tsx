...
export const GameCard = ({
  ...
  const showSeeMore = !currentUser || onFavoritePage;

  return (
    <div className="w-[150px]h-[320px]] rounded-md border-1 border-black z-0 mb-[10px] relative">
      <Link
        href={`/game/${id}`}
        ...
        <div className="flex-1 bg-white dark:bg-zinc-800 text-black dark:text-white rounded-md w-[250px]">
          ...
          <div className="mt-3 flex justify-between text-sm font-medium">
            ...
            <div className="flex flex-col">
              <div className="ml-18">
                {showSeeMore? (
                  <Button asChild variant="link" className="p-0 h-auto text-black underline mb-[10px]">
                    <Link href={`/game/${id}`}>
